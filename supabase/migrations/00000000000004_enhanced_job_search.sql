...
-- Create regions table for location normalization
CREATE TABLE regions (
    id bigint PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    name text NOT NULL,
    type text NOT NULL, -- 'metro', 'state', 'country', 'continent'
    parent_id bigint REFERENCES regions(id),
    code text, -- State/Country codes
    latitude decimal,
    longitude decimal,
...
-- Create location patterns table
